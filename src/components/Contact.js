...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-gradient-to-br from-gray-600 to-indigo-600">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap bg-gradient-to-r from-slate-900 to-slate-700 flex-wrap">
        ...
        >
          ...
          <p className="leading-relaxed mb-5 text-white">
            Let's connect! Feel free to reach out with any inquiries or just to say hello. I'm here to help you. 
          </p>
        ...
        <div className="lg:w-2/3 md:w-1/2 rounded-lg overflow-hidden sm:ml-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <p className="leading-relaxed">0914080045</p>
            </div>
          </div>
        </div>
      </div>
